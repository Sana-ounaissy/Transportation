...
let dr = JSON.parse(localStorage.getItem('allChats'));
console.log(dr.length);
for(let i=0; i<dr.length; i++){
    card.innerHTML+= ` <div class="card" data-label="In Progress">
    <div class="card__container">
        <h1 class="card__header" id="driverName">
    
      </h1>
      <p class="card__body" id ="card">
       `+ dr[i].liveChat +`
      </p>  
    </div>
  </div>
...
let drname=document.getElementById("driverName");
